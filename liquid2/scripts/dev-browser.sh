...
api_label="dev.liquid2.api-6011"
web_label="dev.liquid2.web-6001"
obsolete_api_label="dev.liquid2.api-6010"
obsolete_web_label="dev.liquid2.web-6011"
bin_path="/tmp/liquid2-dev-api"
api_stdout_path="/tmp/liquid2-dev-api-6011.log"
api_stderr_path="/tmp/liquid2-dev-api-6011.err"
web_stdout_path="/tmp/liquid2-dev-web-6001.log"
web_stderr_path="/tmp/liquid2-dev-web-6001.err"
...
fallback_api_addr="127.0.0.1:6011"
fallback_api_url="http://127.0.0.1:6011"
fallback_web_host="127.0.0.1"
fallback_web_port="6001"
fallback_web_url="http://127.0.0.1:6001"
fallback_db="${HOME}/research-artifacts/liquid2/liquid2/runtime/dev-6011/liquid2-dev.db"

usage() {
  cat <<EOF
usage: $0 <start|stop|restart|status|logs|build|install>

This script only selects Liquid2 development mode and controls launchd/Flutter.
...
bootout_obsolete_services() {
  bootout_service "${HOME}/Library/LaunchAgents/${obsolete_api_label}.plist" "$obsolete_api_label"
  bootout_service "${HOME}/Library/LaunchAgents/${obsolete_web_label}.plist" "$obsolete_web_label"
}
