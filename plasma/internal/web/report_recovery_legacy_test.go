// Historical Web projection fixtures; production recovery belongs to reportworkflow.
package web
...
func reportDraftRequestFromPendingEvent(event ledger.Event) (reportexecution.DraftRequest, error) {
	return reportexecution.LegacyRecoveryDraftRequest(event, reportexecution.RecoveryDefaults{RigorLevel: legacyPendingReportRigorLevel, ReportMode: defaultReportMode, SessionPolicy: reportSessionPolicySameSession, GuidanceProfile: reportprompt.ProfileVisualPlan})
}
...
func (server *Server) loadSectionalReportProgress(ctx context.Context, missionID string, pendingEventID string) (sectionalReportProgress, error) {
	...
	lineage, err := reportexecution.ReportRecoveryLineage(events, pendingEventID)
	if err != nil {
		return sectionalReportProgress{}, err
	}
...
func applyPlannedReportProgress(pendingEventID string, event ledger.Event, progress *plannedReportProgress) error {
...
func (server *Server) applySectionalPlanProgress(ctx context.Context, pendingEventID string, event ledger.Event, progress *sectionalReportProgress) error {
	var payload struct {
		PendingEventID               string                   `json:"pending_event_id"`
		ReportMode                   string                   `json:"report_mode"`
		ArtifactID                   string                   `json:"artifact_id"`
...
func reportSectionStartedMatches(pendingEventID, planEventID string, event ledger.Event) bool {
	var payload struct {
		PendingEventID string `json:"pending_event_id"`
...
func applyPartPlanProgress(missionID string, pendingEventID string, planEventID string, partCount int, event ledger.Event, progress *sectionalReportProgress) error {
...
func (server *Server) applySectionProgress(ctx context.Context, pendingEventID string, planEventID string, event ledger.Event, progress *sectionalReportProgress) error {
	var payload struct {
		PendingEventID string `json:"pending_event_id"`
		PlanEventID    string `json:"plan_event_id"`
		ArtifactID     string `json:"artifact_id"`
...
func (server *Server) applyPartProgress(ctx context.Context, pendingEventID string, planEventID string, event ledger.Event, progress *sectionalReportProgress) error {
	var payload struct {
		PendingEventID string `json:"pending_event_id"`
		PlanEventID    string `json:"plan_event_id"`
		ArtifactID     string `json:"artifact_id"`
...
func (server *Server) applyPartEditProgress(ctx context.Context, pendingEventID string, planEventID string, event ledger.Event, progress *sectionalReportProgress) error {
	var payload struct {
		PendingEventID string `json:"pending_event_id"`
		PlanEventID    string `json:"plan_event_id"`
		PartIndex      int    `json:"part_index"`
