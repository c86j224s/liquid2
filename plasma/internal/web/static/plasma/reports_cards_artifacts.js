(function reportsArtifactCards(root) {
  ...
  function renderArtifactCard(key, isLatest, payload, selectedKey) {
    ...
    const planLabel = planData.summary ? `${sectionCount}개 섹션 / ${planData.summary}` : (payload.report_mode === "one_take" ? "원테이크 생성: 별도 계획 없음" : "기록된 생성 계획 없음");
