(function (global) {
  ...
  function renderPlasmaMarkdown(root, markdown) {
    ...
    if (global.Plasma?.reports?.renderPlasmaMermaid) global.Plasma.reports.renderPlasmaMermaid(root);
  }
  ...
  Object.assign(global.Plasma.reports, { plasmaMathOptions: mathOptions, installMarkdownItMath, renderPlasmaMath, renderPlasmaMarkdown, bindReportHeadingInteractions, renderDesignedTextMath, plasmaMathSanitizeOptions });
