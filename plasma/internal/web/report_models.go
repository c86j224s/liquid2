...
const (
	...
	reportSessionPolicyFreshSession = reportexecution.SessionPolicyFreshSession

	reportSessionPolicySelectionAutoFreshSession        = reportexecution.SessionPolicySelectionAutoFreshSession
