...
const (
	...
	ToolReportILSourcesList                         = "plasma.report_il.sources.list"
	ToolReportILSourcesRead                         = "plasma.report_il.sources.read"
	ToolReportILSourcesQuote                        = "plasma.report_il.sources.quote"
	ToolReportILEditorialMemoryStart                = "plasma.report_il.memory.start"
	ToolReportILEditorialMemoryAppend               = "plasma.report_il.memory.append"
	ToolReportILEditorialMemoryRead                 = "plasma.report_il.memory.read"
	ToolReportILEditorialMemoryFinalize             = "plasma.report_il.memory.finalize"
	ToolReportILDocumentStart                       = "plasma.report_il.document.start"
	ToolReportILDocumentOpen                        = "plasma.report_il.document.open"
	ToolReportILDocumentAppend                      = "plasma.report_il.document.append"
	ToolReportILDocumentAppendSource                = "plasma.report_il.document.append_source"
	ToolReportILDocumentRead                        = "plasma.report_il.document.read"
	ToolReportILDocumentReplace                     = "plasma.report_il.document.replace"
	ToolReportILDocumentEditText                    = "plasma.report_il.document.edit_text"
	ToolReportILDocumentReviseBlock                 = "plasma.report_il.document.revise_block"
	ToolReportILDocumentFinalize                    = "plasma.report_il.document.finalize"
	ToolReportILLongFormPlanSubmit                  = "plasma.report_il.long_form.plan.submit"
	ToolReportILLongFormPlanRead                    = "plasma.report_il.long_form.plan.read"
	ToolReportILLongFormDocumentStart               = "plasma.report_il.long_form.document.start"
	ToolReportILLongFormDocumentAppend              = "plasma.report_il.long_form.document.append"
	ToolReportILLongFormDocumentRead                = "plasma.report_il.long_form.document.read"
	ToolReportILLongFormDocumentReplace             = "plasma.report_il.long_form.document.replace"
	ToolReportILLongFormDocumentCorrectBlock        = "plasma.report_il.long_form.document.correct_block"
	ToolReportILLongFormDocumentFinalize            = "plasma.report_il.long_form.document.finalize"
