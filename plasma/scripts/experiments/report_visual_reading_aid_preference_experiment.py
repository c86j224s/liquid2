#!/usr/bin/env python3
"""Issue #174 visual reading-aid preference experiment runner."""
...
EXPERIMENT_ID = "28-report-visual-reading-aid-preference-2026-07-22"
ARMS = ("visual_plan", "visual_reading_aid_preferred")
CANDIDATE_ARM = "visual_reading_aid_preferred"
PROFILE_BY_ARM = {
    "visual_plan": "visual-plan",
    "visual_reading_aid_preferred": "visual-reading-aid-preferred",
}
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--seed", type=int, default=17427)
    ...
    for pair in analysis["pairs"]:
        ...
        packet = {
            ...
            "review_questions": [
                ...
                "When the source contains structure, does the report use a compact visual aid instead of overloading prose?",
                "Does each visual's precision match the source resolution instead of implying unsupported certainty?",
                "Do quantitative, benchmark, or architecture visuals preserve source-backed facts without requiring stock-chart-grade exactness?",
