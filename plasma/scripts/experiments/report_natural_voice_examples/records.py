...
from report_natural_voice_correction.edits import parse_model_response, response_schema, split_document_lines
...
def validate_record(
    ...
    if phase and phase[0] == "calibration":
        if len(phase) != 2 or arm != "examples":
    ...
    _validate_artifact(archive, record, run_dir, "raw_output", ".json")
