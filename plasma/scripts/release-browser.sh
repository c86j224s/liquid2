...
label="release.plasma.browser-3002"
bin_path="/tmp/plasma-release-browser-server"
fallback_url="http://127.0.0.1:3002"
stdout_path="/tmp/plasma-release-browser-3002.log"
stderr_path="/tmp/plasma-release-browser-3002.err"
...
This script only selects Plasma release mode and controls launchd. Runtime
